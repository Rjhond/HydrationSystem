...
INSERT INTO `users` (`usersid`, `username`, `password`, `fname`, `mname`, `lname`, `securityQ`, `securityA`, `RegDate`, `visitTime`, `birthdate`, `contact_id`, `activity_id`, `bio`, `weight`, `address`) VALUES
(2, 'user1', '123', 'john', 'm', 'smith', 'What is your pet\'s name?', 'enzo', '2024-05-16 04:04:05', '2024-05-16 04:04:05', '0000-00-00', 1, 1, '', 70.00, NULL);
